...
P3579 standardizes how AIS consume external time series; P3998 addresses the complementary direction — the internal temporal data records that AIS produce. Together, they cover both sides of the relationship between AIS and time series.

*(jschneerson, 2026-03-26)*
